...
import com.mobisys.music.domain.ListSong;
import com.mobisys.music.service.ListSongService;
...
public class ListSongController {
    ...
    public Object addListSong(HttpServletRequest request){
        ...
        if(flag){
            ...
            jsonObject.put(Consts.MSG,"歌单添加单个歌曲成功");
            return jsonObject;
        }else {
            jsonObject.put(Consts.CODE,0);
            jsonObject.put(Consts.MSG,"歌单添加单个歌曲失败");
            return jsonObject;
        }
    }
