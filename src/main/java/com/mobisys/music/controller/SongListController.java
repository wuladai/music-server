...
import com.mobisys.music.domain.SongList;
import com.mobisys.music.service.SongListService;
...
public class SongListController {
     ...
     * 根据风格模糊查询歌单列表
     */
    @RequestMapping(value = "/songListlikeStyle",method = RequestMethod.GET)
    ...
    public Object updateSongListPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id")int id){
        ...
        try {
            ...
            jsonObject.put(Consts.CODE,0);
            jsonObject.put(Consts.MSG,"上传歌单图片失败"+e.getMessage());
        }finally {
            return jsonObject;
        }
    }
