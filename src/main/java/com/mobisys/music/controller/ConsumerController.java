...
import com.mobisys.music.domain.Consumer;
import com.mobisys.music.service.ConsumerService;
...
public class ConsumerController {
    ...
    public Object addConsumer(HttpServletRequest request) {
        ...
        if (flag) {   //保存成功
            ...
            jsonObject.put(Consts.MSG, "添加Consumer成功");
            return jsonObject;
        }else{
            jsonObject.put(Consts.CODE, 0);
            jsonObject.put(Consts.MSG, "添加Consumer失败");
            return jsonObject;
        }
    }
    ...
    public Object updateConsumer(HttpServletRequest request) {
        ...
        if (flag) {   //保存成功
            jsonObject.put(Consts.CODE, 1);
            jsonObject.put(Consts.MSG, "修改Consumer成功");
            return jsonObject;
        }
        jsonObject.put(Consts.CODE, 0);
        jsonObject.put(Consts.MSG, "修改Consumer失败");
        return jsonObject;
    }
    ...
    public Object updateConsumerPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id") int id) {
        ...
        try {
            ...
            jsonObject.put(Consts.CODE, 0);
            jsonObject.put(Consts.MSG, "上传用户头像失败" + e.getMessage());
        } finally {
            return jsonObject;
        }
    }
